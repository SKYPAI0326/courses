...
| `gemini-notebooklm-workshop/` | Gemini × NotebookLM 跨部門 AI 工作坊（8h · 2 天 × 4h 客製） | 完成 | 9 頁（CH0/CH1-1/CH1-2/CH1-3/CH1-4/CH2-1 + home-cards 5 部門對照卡 + maintenance 3 月維護清單 + index）+ 25 份髒資料 dataset（5 主版 + 20 部門變體）+ 32 dialog-box + 21 expected-output + 3 替換 3 格框含句型支架 + 1 課中對帳 checkpoint；指定雙工具（Gemini + NotebookLM）；跨部門 5 代表（財/業/電/倉/採）；Codex 三審 9.1/10 ACCEPT；主色鼠尾草綠 |
