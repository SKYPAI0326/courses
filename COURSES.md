...
| `ict-ai-digital-workflow/` | ICT共同職能：AI數位工具應用與職場工作流程實務（5h） | 完成（已註冊・公開） | 6 頁（index + CH1~CH5）+ 免費／離線素材包；一般職場工作者；主色霧藍；Codex G5：L4a 7.8、L4b 8.4、L5 7.7；**特殊公開課程，無密碼關卡（2026-08-04 確認）** |
