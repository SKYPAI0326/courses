...
A 是工程背景偏弱的非工程師、第 1 次走完整流程，從上午 10:00 開始到 11:30 結束，總計 **90 分鐘**。但她事前已經有兩個有利條件：(a) #02 合約版她跑過 → n8n UI 不陌生 (b) 中間沒被 Slack / 會議打斷。**多數非工程師學員第一次走，會落在 90-120 分鐘區間，更接近 120 端**：
